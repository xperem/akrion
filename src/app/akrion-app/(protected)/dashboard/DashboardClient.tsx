...
import { DeleteModal } from '@/components/akrion-app/DeleteModal';
import { useToast } from '@/components/akrion-app/Toast';
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200/60 p-4 hover:border-blue-200 hover:bg-blue-50/30 transition-all duration-200 shadow-sm">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button
                          onClick={() => openDeleteModal(product.id, product.name || 'Sans nom')}
