import { questions, results } from '@/lib/akrion-toolbox/classification/classificationWizard';
import type { QuestionID, ResultID, Question, Result } from '@/types/akrion-toolbox/classificationWizard';
